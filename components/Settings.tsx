              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                 ...
                 <div className="flex items-center justify-between p-6 bg-slate-50 rounded-[32px] border border-slate-100">
                    ...
                    <div className="flex items-center space-x-3 bg-white rounded-2xl border border-slate-200 p-1.5 shadow-sm">
                       <button onClick={() => updateStoreConfig({...storeConfig, printerCopies: Math.max(1, (storeConfig.printerCopies || 1) - 1)})} className="p-1.5 text-slate-400 hover:text-indigo-600"><Minus size={18} /></button>
                       <span className="w-8 text-center font-black text-base">{storeConfig.printerCopies || 1}</span>
                       <button onClick={() => updateStoreConfig({...storeConfig, printerCopies: (storeConfig.printerCopies || 1) + 1})} className="p-1.5 text-slate-400 hover:text-indigo-600"><Plus size={18} /></button>
                    </div>
                 </div>
              </div>
           </section>
